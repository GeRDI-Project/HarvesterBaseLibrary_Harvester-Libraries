...
public class HarvesterFacade
{
     ...
     *
     * @param formParams should include 'from' and 'to'
     ...
     *
     * @param formParams a generic list of x-www-form-urlencoded key value pairs
    ...
    public String setProperties( final MultivaluedMap<String, String> formParams )
    {
        ...
        for (Entry<String, List<String>> entry : formParams.entrySet())
        {
            ...
            if (validProperties.contains( key ))
            {
                ...
                {
                    // set harvester property and add the change to the response string
    ...
    {
        final String latestChecksum = ""; // TODO get from Elasticsearch or from prospector(?)
