...
{
    private final AbstractParameter<?> paramToBeRegistered;


    /**
     * Constructor that sets up the payload.
     *
     * @param paramToBeRegistered the parameter that is to be registered in the {@linkplain Configuration}.
     */
    public RegisterParameterEvent(AbstractParameter<?> paramToBeRegistered)
    {
        this.paramToBeRegistered = paramToBeRegistered;
    }
     ...
     */
    public AbstractParameter<?> getParamToBeRegistered()
    {
        return paramToBeRegistered;
    }
}
