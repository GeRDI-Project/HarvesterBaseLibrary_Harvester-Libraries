...
public class DevelopmentToolsFacade
{
			...
			@FormParam ("write_to_disk") String writeToDisk )
	{
		...
		{
			boolean state = autoSave.equals( OPTION_YES_1 ) || autoSave.equals( OPTION_YES_2 )
					|| autoSave.equals( OPTION_YES_3 );
		...
		{
			boolean state = autoSubmit.equals( OPTION_YES_1 ) || autoSubmit.equals( OPTION_YES_2 )
					|| autoSubmit.equals( OPTION_YES_3 );
		...
		{
			boolean state = readFromDisk.equals( OPTION_YES_1 ) || readFromDisk.equals( OPTION_YES_2 )
					|| readFromDisk.equals( OPTION_YES_3 );
		...
		{
			boolean state = writeToDisk.equals( OPTION_YES_1 ) || writeToDisk.equals( OPTION_YES_2 )
					|| writeToDisk.equals( OPTION_YES_3 );
