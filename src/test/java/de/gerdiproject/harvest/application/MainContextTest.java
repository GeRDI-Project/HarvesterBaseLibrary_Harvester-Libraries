...
public class MainContextTest extends AbstractUnitTest
{
    ...
    public MainContextTest(boolean shouldInitBeSuccessful)
    {
        ...
        this.configFile = MainContextUtils.getConfigurationFile(mockedContextListener.getServiceName(), MainContextTest.class);
    ...
    public void before() throws InstantiationException
    {
        ...
        if (configFile.exists())
            throw new InstantiationException(CLEANUP_CONFIG_ERROR + configFile.toString());
